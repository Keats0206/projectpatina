...
const Navbar11 = ({ className, isContained }: Navbar11Props) => {
  ...
  return (
    <Fragment>
      <section
        className={cn(
          isContained
            ? "pointer-events-auto sticky top-0 z-10 flex h-16 w-full items-center justify-center border-b bg-background/95 backdrop-blur"
